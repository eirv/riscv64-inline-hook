...
class TrampolineAllocator {
 public:
  ...
  void* (*custom_alloc)(size_t size, void* data);
  void (*custom_free)(void* mem, void* data);
  void* data;

  inline TrampolineAllocator(TrampolineType t = TrampolineType::kDefault)
      : type(t), custom_alloc(nullptr), custom_free(nullptr), data(nullptr) {
  }

  inline TrampolineAllocator(decltype(custom_alloc) a, decltype(custom_free) f, void* d = nullptr)
...
void UnhookFunction(func_t address);
...
template <typename Data, typename Func = void*>
...
// clang-format off
RV64_HookHandle* RV64_InlineHook(void* address, void* hook, void** backup) __asm__("_ZN8rv64hook10InlineHookEPvS0_PS0_");
...
RV64_HookHandle* RV64_InlineInstrument(
    ...
    void* data,
    void** backup) __asm__("_ZN8rv64hook16InlineInstrumentEPvPFvPNS_15RegisterContextEPNS_10HookHandleES0_ES6_S0_PS0_");
...
void RV64_UnhookFunction(void* address) __asm__("_ZN8rv64hook14UnhookFunctionEPv");
